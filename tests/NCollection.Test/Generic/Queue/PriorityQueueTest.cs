...
namespace NCollection.Test.Generic.Queue
{
    public class PriorityQueueTest
    {
        ...
        public void ContructorWithInitialCapacityAndComparer_Should_Throw_When_ComparerIsNull()
            => Assert.Throws<ArgumentNullException>(() => new PriorityQueue<int>(0, null!));
        ...
        public void ContructorEnumerableAndComparer_Should_Throw_When_EnumerableIsNull()
            => Assert.Throws<ArgumentNullException>(() => new PriorityQueue<int>((IEnumerable<int>)null, Comparer<int>.Default));
        
        [Fact]
        public void ContructorEnumerableAndComparer_Should_Throw_When_ComparerIsNull()
            => Assert.Throws<ArgumentNullException>(() => new PriorityQueue<int>(new ArrayList<int>(), null));
        ...
        public void Contructor(int size)
        {
            ...
            var newQueue = new PriorityQueue<int>(queue);
        ...
        {
            IQueue queue = new PriorityQueue<int>(Comparer<int>.Default);
        ...
        {
            IQueue queue = new PriorityQueue<int>();
        ...
        public void Clone()
        {
            ...
            var clone = (IQueue<int>)queue.Clone();
        ...
        public void  IClonable_Clone()
        {
            ...
            clone.Should().NotBeNull();
            (clone is IQueue<int>).Should().BeTrue();
            var cloneEnumerator = ((IQueue<int>)clone).GetEnumerator();
            var enumerator = queue.GetEnumerator();
